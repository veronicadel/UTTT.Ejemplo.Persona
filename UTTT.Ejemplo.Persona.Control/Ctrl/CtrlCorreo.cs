    ...
    public class CtrlCorreo
    {
        public void enviarCorreo(String message)
        {
            try
            {
                ...
                mailMessage.From = new MailAddress("16300987@uttt.edu.mx");
                mailMessage.To.Add(new MailAddress("16300987@uttt.edu.mx"));
                ...
                smtpClient.Credentials = new NetworkCredential("16300987@uttt.edu.mx", "V555655V");
